...
### 3. Data List Management (Recursive Processing)

* **Hierarchical Lists:** Dlim supports nested datalists, where a master list can reference other lists. This allows for organized, multi-scale data management (e.g., a "Global" list pointing to "Regional" lists).
